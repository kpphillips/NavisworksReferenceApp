...
@implementation SelectViewController{    //#UPDATE 1.1
...
- (void)viewDidLoad
{
    ...
    UIImage *img1 = [UIImage imageNamed:@"06_01_ColorAll_done.png"];
	UIImage *img2 = [UIImage imageNamed:@"06_02_box.png"];
	UIImage *img3 = [UIImage imageNamed:@"06_03_boxWindowSelect.png"];
    UIImage *img4 = [UIImage imageNamed:@"06_04_SelRes.png"];
    UIImage *img5 = [UIImage imageNamed:@"06_05_SelResFile.png"];
    UIImage *img6 = [UIImage imageNamed:@"06_06_SelRes.png"];
    UIImage *img7 = [UIImage imageNamed:@"06_07_SelResObj.png"];
    UIImage *img8 = [UIImage imageNamed:@"06_08_SelResGeom.png"];
    UIImage *img9 = [UIImage imageNamed:@"06_09_GeomSel.png"];
    ...
    textView.text = @"1. Click the dropdown tab on the select tool.";
...
- (IBAction)button1Pressed:(id)sender {
    ...
    textView.text = @"2. Select the selection box tool.";
...
- (IBAction)button2Pressed:(id)sender {
    ...
    textView.text = @"3. Window select an area of the model. Only items in the selection will be selected. Switch back to the pointer selection tool and choose the dropdown on the Select & Search palette.";
...
- (IBAction)button3Pressed:(id)sender {
    ...
    textView.text = @"4. Changing the selection resolution defines which objects hierarchy will be selected.  Choose the file option.";
...
- (IBAction)button4Pressed:(id)sender {
    ...
    textView.text = @"5. Select the window on the model.  The entire file is selected that hosts that window. Change the selection resolution again.";
...
- (IBAction)button5Pressed:(id)sender {
    ...
    textView.text = @"6. Choose Last Object as the resolution.";
...
- (IBAction)button6Pressed:(id)sender {
    ...
    textView.text = @"7. Select the window again and only the window is highlighted based on this resolution.  Change the resolution one last time.";
...
- (IBAction)button7Pressed:(id)sender {
    ...
    textView.text = @"8. Choose Geometry this time as the resolution.";
...
- (IBAction)button8Pressed:(id)sender {
    ...
    textView.text = @"9. Select the window again. You can now drill down into the parts of the window and select the glazing or trim of the window. SHORTCUT: You can toggle through each resolution by holding down the shift button and selecting multiple times on the same object, try it out.";
