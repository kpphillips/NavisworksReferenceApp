...
#import "TimelinerOpViewController.h"
#import "SWRevealViewController.h"
#import "Flurry.h"

@interface TimelinerOpViewController ()

@end

@implementation TimelinerOpViewController{    //#UPDATE 1.1
...
- (void)viewDidLoad
{
    [Flurry logEvent:@"016a Timeliner Options"];
    ...
    UIImage *img1 = [UIImage imageNamed:@"16a_01.png"];
	UIImage *img2 = [UIImage imageNamed:@"16a_02.png"];
	UIImage *img3 = [UIImage imageNamed:@"16a_03.png"];
    UIImage *img4 = [UIImage imageNamed:@"16a_04.png"];
    UIImage *img5 = [UIImage imageNamed:@"16a_05.png"];
    UIImage *img6 = [UIImage imageNamed:@"16a_06.png"];
    UIImage *img7 = [UIImage imageNamed:@"16a_07.png"];
    UIImage *img8 = [UIImage imageNamed:@"16a_08.png"];
    UIImage *img9 = [UIImage imageNamed:@"16a_09.png"];
    UIImage *img10 = [UIImage imageNamed:@"16a_10.png"];
    UIImage *img11 = [UIImage imageNamed:@"16a_11.png"];
    UIImage *img12 = [UIImage imageNamed:@"16a_12.png"];
    UIImage *img13 = [UIImage imageNamed:@"16a_13.png"];
    ...
    textView.text = @"1. With the Timeliner tool open and the Simulate tab selected, select the export button to display the exporting options.";
    ...
    NSArray *buttons = [NSArray arrayWithObjects: self.button1, self.button2, self.button3, self.button4, self.button5, self.button6,self.button7,self.button8, self.button9, self.button10, self.button11, self.button12, self.button13, nil];
...
- (IBAction)button1Pressed:(id)sender {
    ...
    textView.text = @"2. Under the Source drop down, select the Timeliner Simulation.";
...
- (IBAction)button2Pressed:(id)sender {
    ...
    textView.text = @"3. Select the Renderer option to Autodesk.  You have other options for export.  Try these later to see the different results.";
...
- (IBAction)button3Pressed:(id)sender {
    ...
    textView.text = @"4. Select the Explicit option for the export size.  This is controlled by the user.  For example, to set a high definition output set the Width to 1920 and the heighth to 1080.";
...
- (IBAction)button4Pressed:(id)sender {
    ...
    textView.text = @"5. Set the FPS or frames per second.  The hight FPS will take longer to render.  Select OK to export the rendering.";
...
- (IBAction)button5Pressed:(id)sender {
    ...
    textView.text = @"6. Select the Data Sources tab to view its options.";
...
- (IBAction)button6Pressed:(id)sender {
    ...
    textView.text = @"7. Select the Add dropdown.";
...
- (IBAction)button7Pressed:(id)sender {
    ...
    textView.text = @"8. There are multiple types of scheduling software that can be imported into Timeliner as tasks.  After import, objects can then be added to the tasks.";
...
- (IBAction)button8Pressed:(id)sender {
    ...
    textView.text = @"9. Select the Configure tab.";
...
- (IBAction)button9Pressed:(id)sender {
    ...
    textView.text = @"10. The Task Type column in the Tasks tab relates to the options in the Configure tab.  Select the Construct item.";
...
- (IBAction)button10Pressed:(id)sender {
    ...
    textView.text = @"11. If the Task Type is set to Construct, that task will inherit its visibility settings.  Under the Start Appearance select the color.";
...
- (IBAction)button11Pressed:(id)sender {
    ...
    textView.text = @"12. To view the available colors that can be applied select the Appearance Definitions.";
...
- (IBAction)button12Pressed:(id)sender {
    ...
    textView.text = @"Color options can be added here if the user needs to communicate the appearance of a task using a different setting.";
