...
#import "AppProfViewController.h"
#import "SWRevealViewController.h"
#import "Flurry.h"

@interface AppProfViewController ()

@end

@implementation AppProfViewController{    //#UPDATE 1.1
...
- (void)viewDidLoad
{
    ...
    [Flurry logEvent:@"010 Appearance Profiler"];
    ...
    UIImage *img1 = [UIImage imageNamed:@"10_01.png"];
	UIImage *img2 = [UIImage imageNamed:@"10_02.png"];
	UIImage *img3 = [UIImage imageNamed:@"10_03.png"];
    UIImage *img4 = [UIImage imageNamed:@"10_04.png"];
    UIImage *img5 = [UIImage imageNamed:@"10_05.png"];
    UIImage *img6 = [UIImage imageNamed:@"10_06.png"];
    UIImage *img7 = [UIImage imageNamed:@"10_07.png"];
    UIImage *img8 = [UIImage imageNamed:@"10_08.png"];
    UIImage *img9 = [UIImage imageNamed:@"10_09.png"];
    UIImage *img10 = [UIImage imageNamed:@"10_10.png"];
    UIImage *img11 = [UIImage imageNamed:@"10_11.png"];
    ...
    textView.text = @"1. Select the Apperance Profiler tool to display the dialog.";
...
- (IBAction)button1Pressed:(id)sender {
    ...
    textView.text = @"2. The Appearance Profiler is used to change colors of selected elements based on properties or sets.  Select the Sets tab to display the sets in the project.";
...
- (IBAction)button2Pressed:(id)sender {
    ...
    textView.text = @"3. Select the first search set in the list to apply its color.";
...
- (IBAction)button3Pressed:(id)sender {
    ...
    textView.text = @"4. Click the color box to pick a color.  You can also set the transparancy value here if needed.";
...
- (IBAction)button4Pressed:(id)sender {
    ...
    textView.text = @"5. Choose a color for the set of objects and select OK.";
...
- (IBAction)button5Pressed:(id)sender {
    ...
    textView.text = @"6. Click the Add button to apply the settings to the selector list.";
...
- (IBAction)button6Pressed:(id)sender {
    ...
    textView.text = @"7. Create a color scheme and add each set to the Selector list.";
...
- (IBAction)button7Pressed:(id)sender {
    ...
    textView.text = @"8. Click the Run button to apply the colors created in the Selector list.";
...
- (IBAction)button8Pressed:(id)sender {
    ...
    textView.text = @"9. The objects will update with the applied color scheme.  This scheme can be exported to be used for future projects.  Select the Save option.";
...
- (IBAction)button9Pressed:(id)sender {
    ...
    textView.text = @"10. Choose a file name and location for to save the file.  The Load button is used in the Appearance Profiler to load this file in future projects.";
...
- (IBAction)button10Pressed:(id)sender {
    ...
    textView.text = @"11. Close the Appearance Profiler tool to have a larger view of the completed model.";
