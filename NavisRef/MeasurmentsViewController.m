...
#import "MeasurmentsViewController.h"
#import "SWRevealViewController.h"
#import "Flurry.h"

@interface MeasurmentsViewController ()

@end

@implementation MeasurmentsViewController{    //#UPDATE 1.1
...
- (void)viewDidLoad
{
    [Flurry logEvent:@"014 Measurement"];
    ...
    UIImage *img1 = [UIImage imageNamed:@"14_01.png"];
	UIImage *img2 = [UIImage imageNamed:@"14_02.png"];
	UIImage *img3 = [UIImage imageNamed:@"14_03.png"];
    UIImage *img4 = [UIImage imageNamed:@"14_04.png"];
    UIImage *img5 = [UIImage imageNamed:@"14_05.png"];
    UIImage *img6 = [UIImage imageNamed:@"14_06.png"];
    UIImage *img7 = [UIImage imageNamed:@"14_07.png"];
    UIImage *img8 = [UIImage imageNamed:@"14_08.png"];
    UIImage *img9 = [UIImage imageNamed:@"14_09.png"];
    UIImage *img10 = [UIImage imageNamed:@"14_10.png"];
    UIImage *img11 = [UIImage imageNamed:@"14_11.png"];
    UIImage *img12 = [UIImage imageNamed:@"14_12.png"];
    UIImage *img13 = [UIImage imageNamed:@"14_13.png"];
    UIImage *img14 = [UIImage imageNamed:@"14_14.png"];
    UIImage *img15 = [UIImage imageNamed:@"14_15.png"];

   
    
	self.imageArray = [NSArray arrayWithObjects:img1, img2, img3, img4,img5,img6,img7,img8,img9,img10,img11,img12,img13,img14,img15, nil];
    //self.imageArrayAnimation = [NSArray arrayWithObjects:img8,img9,img10,img11, nil];
    
    
    imageView.image = [imageArray objectAtIndex:0];
    textView.text = @"1. Select the Review tab to display the measurement tools.";
...
- (IBAction)button1Pressed:(id)sender {
    ...
    textView.text = @"2. Select a Viewpoint or navigate to an area of the model to to take a measurement.";
...
- (IBAction)button2Pressed:(id)sender {
    ...
    textView.text = @"3. You may need to hide elements in the view to select other elements that are loced behind.  Using the selection tool click on the element in front.";
...
- (IBAction)button3Pressed:(id)sender {
    ...
    textView.text = @"4. To hide the element either right click and hide or use the shortcut control/H on the keyboard. ";
...
- (IBAction)button4Pressed:(id)sender {
    ...
    textView.text = @"5. Select the dropdown under the measurement tool.";
...
- (IBAction)button5Pressed:(id)sender {
    ...
    textView.text = @"6. Select the Point to Point Measure tool.";
...
- (IBAction)button6Pressed:(id)sender {
    ...
    textView.text = @"7. Hover over the first point and look for the snap crosshair to display.  Select the corner of the object.";
...
- (IBAction)button7Pressed:(id)sender {
    ...
    textView.text = @"8. Hover over the second point and click when you aquire the correct point.";
...
- (IBAction)button8Pressed:(id)sender {
    ...
    textView.text = @"9. Select the Convert to Redline.  The measurement will be saved to a new Viewpoint.";
...
- (IBAction)button9Pressed:(id)sender {
    ...
    textView.text = @"10. Name the new Viewpoint";
...
- (IBAction)button10Pressed:(id)sender {
    ...
    textView.text = @"11. Sometimes you will need the measurement between two objects.  Select the first object for the measurement.  In this case one of the light fixures.";
...
- (IBAction)button11Pressed:(id)sender {
    ...
    textView.text = @"12. Use the control key and select the second object for the measurement.";
...
- (IBAction)button12Pressed:(id)sender {
    ...
    textView.text = @"13. With two items selected the Shortest Distance tool will become active. Select this tool.";
...
- (IBAction)button13Pressed:(id)sender {
    ...
    textView.text = @"The shortest distance between the two objects will be displayed. You can use the Convert to Redline tool to save the measurement.  If you navigate the model the non-converted measurement will be removed.";
