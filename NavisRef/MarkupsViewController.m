...
#import "MarkupsViewController.h"
#import "SWRevealViewController.h"
#import "Flurry.h"

@interface MarkupsViewController ()

@end

@implementation MarkupsViewController{    //#UPDATE 1.1
...
- (void)viewDidLoad
{
    ...
    UIImage *img1 = [UIImage imageNamed:@"15_01.png"];
	UIImage *img2 = [UIImage imageNamed:@"15_02.png"];
	UIImage *img3 = [UIImage imageNamed:@"15_03.png"];
    UIImage *img4 = [UIImage imageNamed:@"15_04.png"];
    UIImage *img5 = [UIImage imageNamed:@"15_05.png"];
    UIImage *img6 = [UIImage imageNamed:@"15_06.png"];
    UIImage *img7 = [UIImage imageNamed:@"15_07.png"];
    UIImage *img8 = [UIImage imageNamed:@"15_08.png"];
    UIImage *img9 = [UIImage imageNamed:@"15_09.png"];
    UIImage *img10 = [UIImage imageNamed:@"15_10.png"];
    UIImage *img11 = [UIImage imageNamed:@"15_11.png"];
    UIImage *img12 = [UIImage imageNamed:@"15_12.png"];
    ...
    textView.text = @"1. Right click on a viewpoint or navigate to and area and create a new one.";
...
- (IBAction)button1Pressed:(id)sender {
    ...
    textView.text = @"2. Select Add Copy to duplicate an existing viewpoint.";
...
- (IBAction)button2Pressed:(id)sender {
    ...
    textView.text = @"3. Name the new viewpoint and select the dropdown on the Draw tool.";
...
- (IBAction)button3Pressed:(id)sender {
    ...
    textView.text = @"4. Select the Elipse draw tool.";
...
- (IBAction)button4Pressed:(id)sender {
    ...
    textView.text = @"5. You have the option to change the color.  Select a color from the pallette.";
...
- (IBAction)button5Pressed:(id)sender {
    ...
    textView.text = @"6. Select the two points to draw an elipse.  You will get a preview after the selecting the first point.";
...
- (IBAction)button6Pressed:(id)sender {
    ...
    textView.text = @"7. Select the dropdown on the Draw tool again.";
...
- (IBAction)button7Pressed:(id)sender {
    ...
    textView.text = @"8. Select the Line tool.";
...
- (IBAction)button8Pressed:(id)sender {
    ...
    textView.text = @"9. Select two points to add a single line.  Draw multiple lines to indicate an arrow.";
...
- (IBAction)button9Pressed:(id)sender {
    ...
    textView.text = @"10. Select the Text tool and click in on the model view where you want the text to show up.";
...
- (IBAction)button10Pressed:(id)sender {
    ...
    textView.text = @"11. Enter the text to display and press OK.";
...
- (IBAction)button11Pressed:(id)sender {
    ...
    textView.text = @"12. The markups will save in the current viewpoint and can be exported to communicate the intended information.";
