...
@implementation NavigationViewController{    //#UPDATE 1.1
...
@synthesize imageArrayAnimation2;
...
- (void)viewDidLoad
{
    [Flurry logEvent:@"005 Navigation"];
    ...
    UIImage *img1 = [UIImage imageNamed:@"05_01_nav_start.png"];
	UIImage *img2 = [UIImage imageNamed:@"05_02_viewcubefront.png"];
	UIImage *img3 = [UIImage imageNamed:@"05_03_viewcubehome.png"];
    UIImage *img4 = [UIImage imageNamed:@"05_04_panSelect.png"];
    UIImage *img5 = [UIImage imageNamed:@"05_05_zoom.png"];
    UIImage *img6 = [UIImage imageNamed:@"05_06_walk.png"];
    UIImage *img7 = [UIImage imageNamed:@"05_07_walk_anm1.png"]; //index 6-10
    UIImage *img8 = [UIImage imageNamed:@"05_08_walk_anm2.png"];
    UIImage *img9 = [UIImage imageNamed:@"05_09_walk_anm3.png"];
    UIImage *img10 = [UIImage imageNamed:@"05_10_walk_anm4.png"];
    UIImage *img11 = [UIImage imageNamed:@"05_11_walk_anm5.png"];
    UIImage *img12 = [UIImage imageNamed:@"05_12_look_anm1.png"]; //index 11-14
    UIImage *img13 = [UIImage imageNamed:@"05_13_look_anm2.png"];
    UIImage *img14 = [UIImage imageNamed:@"05_14_look_anm3.png"];
    UIImage *img15 = [UIImage imageNamed:@"05_15_look_anm4.png"];
    UIImage *img16 = [UIImage imageNamed:@"05_16_orbit.png"];
    UIImage *img17 = [UIImage imageNamed:@"05_17_pivotRotate.png"];
    ...
    self.imageArrayAnimation2 = [NSArray arrayWithObjects: img12,img13,img14,img15, nil];
    
    
    imageView.image = [imageArray objectAtIndex:0];
    textView.text = @"The Viewpoint tab gives has selectable tools for Navigation.  These tools are also accessible from the View Cube and the Navigation Bar. Another method is using keyboard shortcuts and the mouse.";
    ...
    NSArray *buttons = [NSArray arrayWithObjects: self.button1, self.button2, self.button3, self.button4, self.button5, self.button6,self.button7,self.button8, self.button9, self.button10, self.button11,self.button12, nil];
    ...
    //fade in the 1st button
    [UIView animateWithDuration:1.00 animations:^{button1.alpha = 1;}]; //OK
    [UIView animateWithDuration:1.00 animations:^{button2.alpha = 1;}]; //OK
    [UIView animateWithDuration:0.00 animations:^{button3.alpha = 0;}]; //1
...
- (IBAction)button1Pressed:(id)sender {
    ...
    textView.text = @"1. Hover over the View Cube and select the front option.";
...
- (IBAction)button3Pressed:(id)sender {
    ...
    textView.text = @"2. Select home icon by the view cube to return to the home view.";
...
- (IBAction)button4Pressed:(id)sender {
    ...
    textView.text = @"3. Select from the pan tool and use the left mouse button to move the model in a linear motion.";
...
- (IBAction)button5Pressed:(id)sender {
    ...
    textView.text = @"4. Select from the zoom tools and use the mouse to left click and perform the related action.";
...
- (IBAction)button6Pressed:(id)sender {
    ...
    textView.text = @"5. The walk and fly tool are used to simulate walking or flying around the Model. Select the walk tool.";
...
//first animation 6 - 10
    ...
    textView.text = @"Select and hold the left mouse button and move the mouse forward and backwards to move in the respected direction. Also, Select and hold the middle or scroll mouse button to move up and down in the Z direction.";
...
//stop first animation
    ...
    textView.text = @"6. Select the look around tool to view the model in a stationary position.";
...
//second animation 11 - 14
    imageView.animationImages = imageArrayAnimation2;
    imageView.animationDuration = 4;
    imageView.animationRepeatCount = 0;
    [imageView startAnimating];
    ...
    textView.text = @"Select and hold the left mouse button and move in any direction to move the focus point from the current position";
...
//stop animation 2
    ...
    textView.text = @"7. Select the orbit tool to rotate the model with a pivot point by selecting the left mouse button and move in a direction.";
...
- (IBAction)button11Pressed:(id)sender {
    ...
    textView.text = @"Shortcut: You can also use the orbit tool by holding down the shift key and the middle mouse button while the mouse.";
