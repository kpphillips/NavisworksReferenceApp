...
#import "SavingFilesViewController.h"
#import "SWRevealViewController.h"
#import "Flurry.h"

@interface SavingFilesViewController ()

@end

@implementation SavingFilesViewController{    //#UPDATE 1.1
...
//static NSInteger textShiftCount = 0;
//static NSInteger textButtonPressedCount = 0;
...
- (void)viewDidLoad
{
    [Flurry logEvent:@"003 Saving Files"];
    ...
    UIImage *img1 = [UIImage imageNamed:@"03_01_AppWindow.png"];
	UIImage *img2 = [UIImage imageNamed:@"03_02_SaveAs.png"];
	UIImage *img3 = [UIImage imageNamed:@"03_03_SaveNWF.png"];
    UIImage *img4 = [UIImage imageNamed:@"03_04_SaveNWF_save.png"];
    UIImage *img5 = [UIImage imageNamed:@"03_05_SaveNWD_save.png"];
    UIImage *img6 = [UIImage imageNamed:@"03_06_NWD_final.png"];
    UIImage *img7 = [UIImage imageNamed:@"03_07_cache_files.png"];
    UIImage *img8 = [UIImage imageNamed:@"03_08_NWF_file.png"];
    UIImage *img9 = [UIImage imageNamed:@"03_09_NWD_file.png"];
    UIImage *img10 = [UIImage imageNamed:@"03_10_Output.png"];
    UIImage *img11 = [UIImage imageNamed:@"03_11_Output_dialog.png"];
    ...
    textView.text = @"1. Select the main applications tab to save your project.";
...
- (IBAction)button1Pressed:(id)sender {
    ...
    textView.text = @"2. Select the Save As option";
...
- (IBAction)button2Pressed:(id)sender {
    ...
    textView.text = @"3. Create a file name and on the drop down menu select .nwf file type.";
...
- (IBAction)button3Pressed:(id)sender {
    ...
    textView.text = @"4. Save the file to close the dialog.";
...
- (IBAction)button4Pressed:(id)sender {
    ...
    textView.text = @"5. Following the previous steps, now save a file type with the following extension: .nwd.";
...
- (IBAction)button5Pressed:(id)sender {
    ...
    textView.text = @"6. We will now take a look at the native files that are created by appending and saving. Open the location of all the files through windows explorer.";
...
- (IBAction)button6Pressed:(id)sender {
    ...
    textView.text = @"7. Cache files are created from design files (.rvt, .dwg, etc.) that are opened or appened in Navisworks.  Notice cache files are smaller than the original files which speed up access to commonly used files.";
...
- (IBAction)button7Pressed:(id)sender {
    ...
    textView.text = @"8. NWF files contain links to the original native files as listed on the Selection Tree. Other data is saved such as review markups. No model geometry is saved with this file format; this makes an NWF considerably smaller in size.";
...
- (IBAction)button8Pressed:(id)sender {
    ...
    textView.text = @"9. NWD files contain all model geometry together with Navisworks data. It is a snapshot of the current state of the model.";
...
- (IBAction)button9Pressed:(id)sender {
    ...
    textView.text = @"10. You have the option to save or publish an NWD file with information by selecting the NWD option under the Output tab";
...
- (IBAction)button10Pressed:(id)sender {
    ...
    textView.text = @"11. You have the option to enter the project information, comments, and password protection. Select OK to publish the file.";
    
    //set text size and origin
    //textView.frame = [self setTextViewSizeAndOrigin];
