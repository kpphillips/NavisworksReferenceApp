...
@implementation FindViewController{    //#UPDATE 1.1
...
- (void)viewDidLoad
{
    ...
    UIImage *img1 = [UIImage imageNamed:@"08_01.png"];
	UIImage *img2 = [UIImage imageNamed:@"08_02.png"];
	UIImage *img3 = [UIImage imageNamed:@"08_03.png"];
    UIImage *img4 = [UIImage imageNamed:@"08_04.png"];
    UIImage *img5 = [UIImage imageNamed:@"08_05.png"];
    UIImage *img6 = [UIImage imageNamed:@"08_06.png"];
    UIImage *img7 = [UIImage imageNamed:@"08_07.png"];
    UIImage *img8 = [UIImage imageNamed:@"08_08.png"];
    UIImage *img9 = [UIImage imageNamed:@"08_09.png"];
    UIImage *img10 = [UIImage imageNamed:@"08_10.png"];
    UIImage *img11 = [UIImage imageNamed:@"08_11.png"];
    UIImage *img12 = [UIImage imageNamed:@"08_12.png"];
    ...
    textView.text = @"1. Select the Find Items tool to display its dialog.";
...
- (IBAction)button1Pressed:(id)sender {
    ...
    textView.text = @"2. The Find Item dialog is used to search appended design files for elements by their associated proptied from the design software.";
...
- (IBAction)button2Pressed:(id)sender {
    ...
    textView.text = @"3. Utilize the properties dialog to determine the the fields to search for.  Conditional statments are built upon object properties from the design software.";
...
- (IBAction)button3Pressed:(id)sender {
    ...
    textView.text = @"4. Select the file for the conditional statment to apply to.";
...
- (IBAction)button4Pressed:(id)sender {
    ...
    textView.text = @"5. Under the Category column select the parameters category.";
...
- (IBAction)button5Pressed:(id)sender {
    ...
    textView.text = @"6. Next, select the property.";
...
- (IBAction)button6Pressed:(id)sender {
    ...
    textView.text = @"7. Select the condition.";
...
- (IBAction)button7Pressed:(id)sender {
    ...
    textView.text = @"8. Select the parmeter.";
...
- (IBAction)button8Pressed:(id)sender {
    ...
    textView.text = @"9. Click find all to search the selected file in the model with selected conditional statement.";
...
- (IBAction)button9Pressed:(id)sender {
    ...
    textView.text = @"10. All the elements with the associated property will highlight in the model.  Click on the Hide Unselected to to isolate the items of the search.";
...
- (IBAction)button10Pressed:(id)sender {
    ...
    textView.text = @"11. You can add additional conditional statements to the search for a more detailed search.  Right click on the line below the previous search to see the options.";
...
- (IBAction)button11Pressed:(id)sender {
    ...
    textView.text = @"12. Using and/or conditions you can define specific categories of elements.  Understanding the parameter names from the design software will help with this.";
